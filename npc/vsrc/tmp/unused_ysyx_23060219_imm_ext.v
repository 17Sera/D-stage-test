// module ysyx_23060219_imme(     //addi
//   input  [31:0]inst,
//   output [31:0]imme
// );
//   wire [31:0] imm;      //取出imm部分并进行符号扩展至32位
//   assign imm = { {20{inst[31]}},inst[31:20] };  //31-20是imm
//   assign imme = imm;

// endmodule

/////// 如果以上可行的话，再换成assign版的以下的结构，便于扩展指令

/*
`include "define.v"
module ysyx_23060219_imme(              //instr_decode
	input [31:0]instr,
	// output [6:0]opcode,
	// output [2:0]func3,
	// output func7,
