...
module ysyx_23060219_exu(
    ...
    wire            exu_brch     = i_exu_is_brch & exu_alu_res[0];  
    //check if is branch inst while branch condition is true
    // to LSU ---> WBU
    ...
    always @(posedge clk) begin
        if(rst == 1'b1) 
            ...
            exu_valid_data_reg <= { exu_exu_res, exu_is_load, exu_is_store, exu_func3, 
                                    ...
                                    exu_imm, exu_pc, exu_is_jal, exu_is_jalr, exu_brch, 
                                    exu_rd_id, exu_gpr_wen, exu_csr_wid, exu_csr_rd, exu_csr_wen };
    end
    ...
    assign{ o_exu_exu_res, o_exu_is_load, o_exu_is_store, o_exu_func3, 
            ...
            o_exu_imm, o_exu_pc, o_exu_is_jal, o_exu_is_jalr, o_exu_brch, 
            o_exu_rd_id, o_exu_gpr_wen, o_exu_csr_wid, o_exu_csr_rd, o_exu_csr_wen } = exu_valid_data_reg;
