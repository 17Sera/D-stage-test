...
module arbiter (
    ...
    // IFU 接口
    input  wire [`CPU_Bus]   i_ifu_araddr,   //读地址
    ...
    input  wire [`CPU_Bus]   i_ifu_awaddr,   //写地址
    input  wire             i_ifu_awvalid,
    output wire             o_ifu_awready,
    input  wire [`CPU_Bus]   i_ifu_wdata,    //写数据
    ...
    // LSU 接口
    input  wire [`CPU_Bus]   i_lsu_araddr,   //读地址
    ...
    // SRAM 接口
    output wire [`CPU_Bus]   o_sram_araddr,   //读地址
