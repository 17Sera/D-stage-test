...
VL_ATTR_COLD void Vysyx_23060219_top___024root__trace_init_sub__TOP__0(Vysyx_23060219_top___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBus(c+85,"mstatus",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+86,"mtvec",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+87,"mepc",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+88,"mcause",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+89,"csr_wdata",-1, FST_VD_IMPLICIT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vysyx_23060219_top___024root__trace_full_sub_0(Vysyx_23060219_top___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+84,((vlSelf->ysyx_23060219_top__DOT__inst 
                              >> 0x14U)),12);
    bufp->fullIData(oldp+85,(vlSelf->ysyx_23060219_top__DOT__csr_regs_inst__DOT__mstatus),32);
    bufp->fullIData(oldp+86,(vlSelf->ysyx_23060219_top__DOT__csr_regs_inst__DOT__mtvec),32);
    bufp->fullIData(oldp+87,(vlSelf->ysyx_23060219_top__DOT__csr_regs_inst__DOT__mepc),32);
    bufp->fullIData(oldp+88,(vlSelf->ysyx_23060219_top__DOT__csr_regs_inst__DOT__mcause),32);
    bufp->fullIData(oldp+89,(vlSelf->ysyx_23060219_top__DOT__csr_regs_inst__DOT__csr_wdata),32);
